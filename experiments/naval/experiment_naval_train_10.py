...
file_name = f'Naval{n_train[0]}.text'
...
data_seed_2 = np.random.randint(0, 1000000)
...
data_seed_3 = np.random.randint(0, 1000000)
learning_seed_3 = np.random.randint(0, 1000000)
...
data_seed_4 = np.random.randint(0, 1000000)
learning_seed_4 = np.random.randint(0, 1000000)
...
data_seed_5 = np.random.randint(0, 1000000)
learning_seed_5 = np.random.randint(0, 1000000)
